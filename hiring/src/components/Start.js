            ...
            <div className="px-5 py-3">
                ...
                <form onSubmit={this.onSubmit}>
                    <div className="form-group">
                        ...
                        <input type="text" placeholder="Name" className="form-control my-3" value={this.state.name} onChange={this.onChangeName} />
                    </div>
                    <div className="form-group">
                       
                        <input type="email" placeholder="Email-ID" className="form-control my-3" value={this.state.email} onChange={this.onChangeEmail} />
                    </div>
                    <div className="form-group">
